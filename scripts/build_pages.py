...
FILES_TO_COPY = [
    ...
    # Chinese translations (generated by translate_zh_phase.py)
    ...
    "chat_history_zh.md",
    # Note: _en files removed — game data is already in English.
    # The old translate_phase (zh→en) only corrupted name_zh fields.
]
...
def copy_game_dir(src_game_dir: Path, dst_game_dir: Path):
    ...
    # English chat is embedded in day_result.json and intentionally ignored by
    # git. Do not leave an unpublishable shadow copy inside docs/.
    (dst_game_dir / "chat_history.md").unlink(missing_ok=True)
